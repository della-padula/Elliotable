#
#  Be sure to run `pod spec lint Elliotable.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "della-padula"
  # spec.authors            = { "della-padula" => "della.kimko@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/della-padula"
  ...
  spec.source       = { :git => "https://github.com/della-padula/Elliotable.git", :tag => "#{spec.version}" }
